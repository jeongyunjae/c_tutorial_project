...
int나 char같은 기본 자료형 외에도, C에서는 사용자가 직접 데이터형을 정의해서 사용할 수 있습니다.
...
이름, 나이, 주소를 각각 관리하면서 서로 연관시키려면 많은 노력이 필요할 것입니다.

그럴때 구조체를 이용해 손쉽게 작업할 수 있습니다.
...
이고 origin의 문자열을 dest로 복사하는 함수로 <string.h>에 있습니다.
...
밑은 프로그램 9.1의 구조체 선언을 typedef형식을 바꾼 것입니다.
